/**
 * Gera atlas de bitmap font VT323 (PNG + XML .fnt) compatível com Phaser load.bitmapFont.
 * Usage: node scripts/gen-bitmap-font-vt323.mjs
 */
...
const TTF_PATH  = join(ROOT, 'public/assets/fonts/VT323-Regular.ttf');
const FONT_SIZE = 64;
const PADDING   = 4;
const ATLAS_W   = 1024;
const ATLAS_H   = 1024;
...
ctx.antialias = 'none'; // VT323 é pixel font — sem antialiasing
...
<font>
  <info face="vt323" size="${FONT_SIZE}" bold="0" italic="0" charset="" unicode="1" stretchH="100" smooth="0" aa="0" padding="0,0,0,0" spacing="1,1" outline="0" />
...
const VARIANTS = [
  { name: 'vt323_gold',  color: '#ffd700' },
  { name: 'vt323_white', color: '#ffffff' },
  { name: 'vt323_blue',  color: '#4499ff' },
];
